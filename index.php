            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                <figure class="thumbnail text-center">
                    ...
                    <figcaption class="caption">
                        ...
                        <p>Cooked by Penny !</p>
                        <form method="POST">
                            <input id="productimage" name="productimage" type="hidden"
                                   value="assets/img/product-46.jpg">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                <figure class="thumbnail text-center">
                    ...
                    <figcaption class="caption">
                        ...
                        <form method="POST">
                            <input id="productimage" name="productimage" type="hidden"
                                   value="assets/img/product-36.jpg">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                <figure class="thumbnail text-center">
                    ...
                    <figcaption class="caption">
                        ...
                        <form method="POST">
                            <input id="productimage" name="productimage" type="hidden"
                                   value="assets/img/product-58.jpg">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                <figure class="thumbnail text-center">
                    ...
                    <figcaption class="caption">
                        ...
                        <form method="POST">
                            <input id="productimage" name="productimage" type="hidden"
                                   value="assets/img/product-32.jpg">
